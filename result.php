    ...
    <script>
        ...
        for (let i = 0; i < POF.length; i++) {
            if(POF[i]=="Pass"){
                ...
                var War1="Re-Mid Notice";
                var War ="If You are Fail in the Mid Exam Than Call Your Parents and Meet With faculties. We would like to inform you that the results of your recent exam have been released. Unfortunately, it appears that you did not pass the exam with the required grade. However, we are pleased to inform you that a re-exam has been scheduled on 17-04-2023 at 09:00 AM TO 10:00 AM.";
